...
const workExperience = [
  {
    ...
    description: [
      ...
      "Worked on software infrastructure and deployment.",
    ],
  },
  {
    ...
    description: [
      ...
      "Developed responsive UI with React, Bootstrap, and MongoDB.",
        ...
        <Col className="text-white text-start bottom-fade-in-slow">
          ...
          {workExperience.map((exp, index) => (
            <div className="mb-5" key={index}>
              ...
              <h5 className="fst-italic fw-normal mb-3">
                {exp.company} &middot; {exp.startDate} &ndash; {exp.endDate}
              </h5>
